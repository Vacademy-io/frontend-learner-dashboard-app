        ...
        <CardContent className="p-4 sm:p-6 md:p-8 text-center">
          ...
          >
            <Target
              weight="duotone"
              size={20}
              className="text-primary-600 sm:w-6 sm:h-6 md:w-8 md:h-8"
            />
          </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0">
            ...
            >
              <Play
                weight="duotone"
                size={16}
                className="text-primary-600 sm:w-4 sm:h-4"
              />
            </div>
                ...
                <p className="text-xs sm:text-sm md:text-base text-gray-600 mt-1 sm:mt-2 flex items-center space-x-2 flex-wrap">
                  {showForInstitutes([HOLISTIC_INSTITUTE_ID]) ? (
                    <>
                      <Sparkles
                        size={12}
                        className="text-primary-500 flex-shrink-0 sm:w-3.5 sm:h-3.5"
                      />
                      <span className="text-xs sm:text-sm md:text-base break-words">
                        Ready for today's yoga journey?
                      </span>
                    </>
                  ) : (
                    <>
                        ...
                        >
                          <div className="flex items-center space-x-1.5 sm:space-x-2 md:space-x-3 min-w-0 flex-1 overflow-hidden">
                            ...
                            <div className="min-w-0 flex-1 overflow-hidden dashboard-flex-container">
                              <h3 className="font-semibold text-gray-900 text-xs sm:text-sm leading-tight session-title dashboard-card-text">
                                {session.title}
                              </h3>
                        ...
                        .map((session, index) => (
                          ...
                          >
                            ...
                            <div className="flex items-center justify-end flex-shrink-0">
                              <Badge
                                variant="secondary"
                                className="bg-info-100 text-info-700 border-info-300 text-xs mobile-badge"
                              >
                                Upcoming
                              </Badge>
                            </div>
                      ...
                      {!liveSessions?.live_sessions?.length &&
                        !liveSessions?.upcoming_sessions?.length && (
                          <div className="text-center py-6 sm:py-8 md:py-12">
                            ...
                            <p className="text-gray-600 mb-3 sm:mb-4 md:mb-6 text-xs sm:text-sm">
