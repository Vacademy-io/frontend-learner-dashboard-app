...
export function EmailLogin({
  ...
  const verifyOtpMutation = useMutation({
    ...
    onSuccess: async (response) => {
      ...
      // await setInstituteIdInStorage(instituteId);

      //  // Redirect to Dashboard if only one authority is found
      // //  navigate({ to: "/dashboard" });
      // try {
      //   // Call API to get institute details
      //   const instituteDetailsResponse = await axios.get(
      ...
      //   // Store institute details in Capacitor storage
